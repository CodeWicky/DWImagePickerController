...
class AssetGridViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        print("enter cell",indexPath.row, CLongLong(round(Date().timeIntervalSince1970*1000)))
        ...
        imageManager.requestImage(for: asset, targetSize: thumbnailSize, contentMode: .aspectFill, options: nil, resultHandler: { image, _ in
            ...
            print("get image",indexPath.row, CLongLong(round(Date().timeIntervalSince1970*1000)))
